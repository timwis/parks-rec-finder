...
export const RECEIVE_SEARCH_LOCATION = 'search/RECEIVE_SEARCH_LOCATION'
...
export const RESET_PROGRAMS = 'programs/RESET_PROGRAMS'
...
export const RESET_FACILITIES = 'facilities/RESET_FACILITIES'
